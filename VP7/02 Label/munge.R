...
seq <- read.dna("RVA_VP7_FullLength.fas",format="fasta",as.matrix=FALSE) #as.matrix = FALSE: always returns the sequences in a list.
...
write.dna(seq, "RVA_VP7_FullLength_annotated.fas", format = "fasta")